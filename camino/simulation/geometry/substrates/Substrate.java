...
public abstract class Substrate{
	...
	/** Substrate bottom left - used to set origin in MeshSubstrate and intialise walkers from file.*/
	public double[] substrateBottomLeft;
    ...
    public final boolean amend(Walker walker, double[] step, double t, int n, boolean report, FileWriter debugWriter){
        ...
        while(crosses){                    
	        	...
	        	getSubstrateCoords(walker, newStep, subsCoords);
